...
module Proj2 (Pitch, toPitch, feedback, initialGuess2,
            GameState, initialGuess, nextGuess, allChords) where
-- TODO: remove allChords and initialGuess2
...
initialGuess2 :: [Pitch] -> ([Pitch], GameState)
initialGuess2 firstGuess = 
    let state = ([], [], deleteChord firstGuess allChords)
    in (firstGuess, state)
-- Combinations: (
...
-- Returns average number of feedback for given pitch
